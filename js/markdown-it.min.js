    ...
    return function e(r, t, n) {
        ...
        1: [function (e, r, t) {
            ...
            var a = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g,
                ...
                l = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, u = e("./entities");
            var p = /[&<>"]/, h = /[&<>"]/g, f = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;"};
            ...
            var m = /[.?*+^$[\]\\(){}|-]/g;
            var _ = e("uc.micro/categories/P/regex");
            t.lib = {}, t.lib.mdurl = e("mdurl"), t.lib.ucmicro = e("uc.micro"), t.assign = function (e) {
                ...
                return e.indexOf("\\") < 0 && e.indexOf("&") < 0 ? e : e.replace(c, function (e, r, t) {
                    return r || function (e, r) {
                        var t = 0;
                        return s(u, r) ? u[r] : 35 === r.charCodeAt(0) && l.test(r) && o(t = "x" === r[1].toLowerCase() ? parseInt(r.slice(2), 16) : parseInt(r.slice(1), 10)) ? i(t) : e
                    }(e, t)
                })
            ...
            r.exports = function (e, r, t) {
                var s, o, i = r, a = {ok: !1, pos: 0, lines: 0, str: ""};
                if (60 === e.charCodeAt(r)) {
                    for (r++; r < t;) {
                        if (10 === (s = e.charCodeAt(r))) return a;
                        if (62 === s) return a.pos = r + 1, a.str = n(e.slice(i + 1, r)), a.ok = !0, a;
                        92 === s && r + 1 < t ? r += 2 : r++
                    }
                    return a
                }
                for (o = 0; r < t && 32 !== (s = e.charCodeAt(r)) && !(s < 32 || 127 === s);) if (92 === s && r + 1 < t) r += 2; else {
                    if (40 === s && o++, 41 === s) {
                        if (0 === o) break;
                        o--
                    }
                ...
                return i === r ? a : 0 !== o ? a : (a.str = n(e.slice(i, r)), a.lines = 0, a.pos = r, a.ok = !0, a)
            }
            ...
            "use strict";
            var n = e("./common/utils"), s = e("./helpers"), o = e("./renderer"), i = e("./parser_core"),
                a = e("./parser_block"), c = e("./parser_inline"), l = e("linkify-it"), u = e("mdurl"),
                p = e("punycode"),
                h = {default: e("./presets/default"), zero: e("./presets/zero"), commonmark: e("./presets/commonmark")},
                f = /^(vbscript|javascript|file|data):/, d = /^data:image\/(gif|png|jpeg|webp);/;
            ...
            function g(e) {
                var r = u.parse(e, !0);
                if (r.hostname && (!r.protocol || _.indexOf(r.protocol) >= 0)) try {
                    r.hostname = p.toASCII(r.hostname)
                } catch (e) {
                }
                return u.encode(u.format(r))
            }
            ...
            function b(e) {
                ...
                return u.decode(u.format(r))
            }

            function k(e, r) {
                if (!(this instanceof k)) return new k(e, r);
                r || n.isString(e) || (r = e || {}, e = "default"), this.inline = new c, this.block = new a, this.core = new i, this.renderer = new o, this.linkify = new l, this.validateLink = m, this.normalizeLink = g, this.normalizeLinkText = b, this.utils = n, this.helpers = n.assign({}, s), this.options = {}, this.configure(e), r && this.set(r)
            }
            ...
            function o() {
                this.ruler = new n;
                for (var e = 0; e < s.length; e++) this.ruler.push(s[e][0], s[e][1], {alt: (s[e][2] || []).slice()})
            }
            ...
            }, o.prototype.State = e("./rules_block/state_block"), r.exports = o
        }, {
            "./ruler": 17,
            ...
            }, o.prototype.State = e("./rules_core/state_core"), r.exports = o
        }, {
            "./ruler": 17,
            "./rules_core/block": 30,
            ...
            }, i.prototype.State = e("./rules_inline/state_inline"), r.exports = i
        }, {
            "./ruler": 17,
            ...
            "use strict";
            var n = e("./common/utils").assign, s = e("./common/utils").unescapeAll, o = e("./common/utils").escapeHtml,
                i = {};
            ...
            r.exports = function (e, r, t, s) {
                var o, i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, C, x, y, A, w = e.lineMax,
                    D = e.bMarks[r] + e.tShift[r], E = e.eMarks[r];
                if (e.sCount[r] - e.blkIndent >= 4) return !1;
                if (62 !== e.src.charCodeAt(D++)) return !1;
                if (s) return !0;
                for (c = f = e.sCount[r] + D - (e.bMarks[r] + e.tShift[r]), 32 === e.src.charCodeAt(D) ? (D++, c++, f++, o = !1, v = !0) : 9 === e.src.charCodeAt(D) ? (v = !0, (e.bsCount[r] + f) % 4 == 3 ? (D++, c++, f++, o = !1) : o = !0) : v = !1, d = [e.bMarks[r]], e.bMarks[r] = D; D < E && (i = e.src.charCodeAt(D), n(i));) 9 === i ? f += 4 - (f + e.bsCount[r] + (o ? 1 : 0)) % 4 : f++, D++;
                for (m = [e.bsCount[r]], e.bsCount[r] = e.sCount[r] + 1 + (v ? 1 : 0), u = D >= E, b = [e.sCount[r]], e.sCount[r] = f - c, k = [e.tShift[r]], e.tShift[r] = D - e.bMarks[r], x = e.md.block.ruler.getRules("blockquote"), g = e.parentType, e.parentType = "blockquote", A = !1, h = r + 1; h < t && (e.sCount[h] < e.blkIndent && (A = !0), !((D = e.bMarks[h] + e.tShift[h]) >= (E = e.eMarks[h]))); h++) if (62 !== e.src.charCodeAt(D++) || A) {
                    if (u) break;
                    for (C = !1, a = 0, l = x.length; a < l; a++) if (x[a](e, h, t, !0)) {
                        C = !0;
                        break
                    }
                    if (C) {
                    ...
                    for (c = f = e.sCount[h] + D - (e.bMarks[h] + e.tShift[h]), 32 === e.src.charCodeAt(D) ? (D++, c++, f++, o = !1, v = !0) : 9 === e.src.charCodeAt(D) ? (v = !0, (e.bsCount[h] + f) % 4 == 3 ? (D++, c++, f++, o = !1) : o = !0) : v = !1, d.push(e.bMarks[h]), e.bMarks[h] = D; D < E && (i = e.src.charCodeAt(D), n(i));) 9 === i ? f += 4 - (f + e.bsCount[h] + (o ? 1 : 0)) % 4 : f++, D++;
                ...
                for (_ = e.blkIndent, e.blkIndent = 0, (y = e.push("blockquote_open", "blockquote", 1)).markup = ">", y.map = p = [r, 0], e.md.block.tokenize(e, r, h), (y = e.push("blockquote_close", "blockquote", -1)).markup = ">", e.lineMax = w, e.parentType = g, p[1] = e.line, a = 0; a < k.length; a++) e.bMarks[a + r] = d[a], e.tShift[a + r] = k[a], e.sCount[a + r] = b[a], e.bsCount[a + r] = m[a];
            ...
            r.exports = function (e, r, t, n) {
                ...
                if (n) return !0;
                for (a = r; !(++a >= t) && !((h = c = e.bMarks[a] + e.tShift[a]) < (f = e.eMarks[a]) && e.sCount[a] < e.blkIndent);) if (e.src.charCodeAt(h) === s && !(e.sCount[a] - e.blkIndent >= 4 || (h = e.skipChars(h, s)) - c < o || (h = e.skipSpaces(h)) < f)) {
                    p = !0;
                    break
                }
            ...
            function s(e, r) {
                var t, s, o, i;
                return s = e.bMarks[r] + e.tShift[r], o = e.eMarks[r], 42 !== (t = e.src.charCodeAt(s++)) && 45 !== t && 43 !== t ? -1 : s < o && (i = e.src.charCodeAt(s), !n(i)) ? -1 : s
            }

            function o(e, r) {
                var t, s = e.bMarks[r] + e.tShift[r], o = s, i = e.eMarks[r];
                if (o + 1 >= i) return -1;
            ...
            r.exports = function (e, r, t, n) {
                var i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, C, x, y, A, w, D, E, q, F, S, L, z, T, I = !1, R = !0;
                if (e.sCount[r] - e.blkIndent >= 4) return !1;
                if (e.listIndent >= 0 && e.sCount[r] - e.listIndent >= 4 && e.sCount[r] < e.blkIndent) return !1;
                if (n && "paragraph" === e.parentType && e.tShift[r] >= e.blkIndent && (I = !0), (q = o(e, r)) >= 0) {
                    if (h = !0, S = e.bMarks[r] + e.tShift[r], b = Number(e.src.substr(S, q - S - 1)), I && 1 !== b) return !1
                } else {
                    if (!((q = s(e, r)) >= 0)) return !1;
                    h = !1
                }
                if (I && e.skipSpaces(q) >= e.eMarks[r]) return !1;
                if (g = e.src.charCodeAt(q - 1), n) return !0;
                for (_ = e.tokens.length, h ? (T = e.push("ordered_list_open", "ol", 1), 1 !== b && (T.attrs = [["start", b]])) : T = e.push("bullet_list_open", "ul", 1), T.map = m = [r, 0], T.markup = String.fromCharCode(g), v = r, F = !1, z = e.md.block.ruler.getRules("list"), y = e.parentType, e.parentType = "list"; v < t;) {
                    for (E = q, k = e.eMarks[v], p = C = e.sCount[v] + q - (e.bMarks[r] + e.tShift[r]); E < k;) {
                        if (9 === (i = e.src.charCodeAt(E))) C += 4 - (C + e.bsCount[v]) % 4; else {
                            if (32 !== i) break;
                            C++
                        }
                        E++
                    }
                    if ((u = (a = E) >= k ? 1 : C - p) > 4 && (u = 1), l = p + u, (T = e.push("list_item_open", "li", 1)).markup = String.fromCharCode(g), T.map = f = [r, 0], D = e.tight, w = e.tShift[r], A = e.sCount[r], x = e.listIndent, e.listIndent = e.blkIndent, e.blkIndent = l, e.tight = !0, e.tShift[r] = a - e.bMarks[r], e.sCount[r] = C, a >= k && e.isEmpty(r + 1) ? e.line = Math.min(e.line + 2, t) : e.md.block.tokenize(e, r, t, !0), e.tight && !F || (R = !1), F = e.line - r > 1 && e.isEmpty(e.line - 1), e.blkIndent = e.listIndent, e.listIndent = x, e.tShift[r] = w, e.sCount[r] = A, e.tight = D, (T = e.push("list_item_close", "li", -1)).markup = String.fromCharCode(g), v = r = e.line, f[1] = v, a = e.bMarks[r], v >= t) break;
                    if (e.sCount[v] < e.blkIndent) break;
                    if (e.sCount[r] - e.blkIndent >= 4) break;
                    for (L = !1, c = 0, d = z.length; c < d; c++) if (z[c](e, v, t, !0)) {
                        L = !0;
                        break
                    }
                    if (L) break;
                    ...
                    if (g !== e.src.charCodeAt(q - 1)) break
                }
                return (T = h ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1)).markup = String.fromCharCode(g), m[1] = v, e.line = v, e.parentType = y, R && function (e, r) {
                    var t, n, s = e.level + 2;
            ...
            r.exports = function (e, r, t, o) {
                var i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, C, x = 0, y = e.bMarks[r] + e.tShift[r],
                    A = e.eMarks[r], w = r + 1;
                if (e.sCount[r] - e.blkIndent >= 4) return !1;
                if (91 !== e.src.charCodeAt(y)) return !1;
                for (; ++y < A;) if (93 === e.src.charCodeAt(y) && 92 !== e.src.charCodeAt(y - 1)) {
                    if (y + 1 === A) return !1;
                ...
                for (A = (b = e.getLines(r, w, e.blkIndent, !1).trim()).length, y = 1; y < A; y++) {
                    if (91 === (i = b.charCodeAt(y))) return !1;
                    if (93 === i) {
                        d = y;
                        break
                    }
                    10 === i ? x++ : 92 === i && ++y < A && 10 === b.charCodeAt(y) && x++
                }
                if (d < 0 || 58 !== b.charCodeAt(d + 1)) return !1;
                for (y = d + 2; y < A; y++) if (10 === (i = b.charCodeAt(y))) x++; else if (!s(i)) break;
                if (!(_ = e.md.helpers.parseLinkDestination(b, y, A)).ok) return !1;
                if (u = e.md.normalizeLink(_.str), !e.md.validateLink(u)) return !1;
                for (a = y = _.pos, c = x += _.lines, g = y; y < A; y++) if (10 === (i = b.charCodeAt(y))) x++; else if (!s(i)) break;
                for (_ = e.md.helpers.parseLinkTitle(b, y, A), y < A && g !== y && _.ok ? (C = _.str, y = _.pos, x += _.lines) : (C = "", y = a, x = c); y < A && (i = b.charCodeAt(y), s(i));) y++;
                if (y < A && 10 !== b.charCodeAt(y) && C) for (C = "", y = a, x = c; y < A && (i = b.charCodeAt(y), s(i));) y++;
            ...
            "use strict";
            var n = e("../token"), s = e("../common/utils").isSpace;

            function o(e, r, t, n) {
                var o, i, a, c, l, u, p, h;
                for (this.src = e, this.md = r, this.env = t, this.tokens = n, this.bMarks = [], this.eMarks = [], this.tShift = [], this.sCount = [], this.bsCount = [], this.blkIndent = 0, this.line = 0, this.lineMax = 0, this.tight = !1, this.ddIndent = -1, this.listIndent = -1, this.parentType = "root", this.level = 0, this.result = "", h = !1, a = c = u = p = 0, l = (i = this.src).length; c < l; c++) {
            ...
            o.prototype.push = function (e, r, t) {
                ...
                return u.join("")
            }, o.prototype.Token = n, r.exports = o
            ...
            r.exports = function (e, r, t, i) {
                ...
                for (h = (c = s(e, r + 1)).split("|"), m = [], u = 0; u < h.length; u++) {
                    if (!(_ = h[u].trim())) {
                ...
                if (i) return !0;
                for ((d = e.push("table_open", "table", 1)).map = g = [r, 0], (d = e.push("thead_open", "thead", 1)).map = [r, r + 1], (d = e.push("tr_open", "tr", 1)).map = [r, r + 1], u = 0; u < h.length; u++) (d = e.push("th_open", "th", 1)).map = [r, r + 1], m[u] && (d.attrs = [["style", "text-align:" + m[u]]]), (d = e.push("inline", "", 0)).content = h[u].trim(), d.map = [r, r + 1], d.children = [], d = e.push("th_close", "th", -1);
                for (d = e.push("tr_close", "tr", -1), d = e.push("thead_close", "thead", -1), (d = e.push("tbody_open", "tbody", 1)).map = b = [r + 2, 0], p = r + 2; p < t && !(e.sCount[p] < e.blkIndent) && -1 !== (c = s(e, p).trim()).indexOf("|") && !(e.sCount[p] - e.blkIndent >= 4); p++) {
                    for (h = o(c.replace(/^\||\|$/g, "")), d = e.push("tr_open", "tr", 1), u = 0; u < f; u++) d = e.push("td_open", "td", 1), m[u] && (d.attrs = [["style", "text-align:" + m[u]]]), (d = e.push("inline", "", 0)).content = h[u] ? h[u].trim() : "", d.children = [], d = e.push("td_close", "td", -1);
            ...
            r.exports = function (e) {
                var r, t, o, i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, C = e.tokens;
                if (e.md.options.linkify) for (t = 0, o = C.length; t < o; t++) if ("inline" === C[t].type && e.md.linkify.pretest(C[t].content)) for (m = 0, r = (i = C[t].children).length - 1; r >= 0; r--) if ("link_close" !== (c = i[r]).type) {
                    if ("html_inline" === c.type && (v = c.content, /^<a[>\s]/i.test(v) && m > 0 && m--, s(c.content) && m++), !(m > 0) && "text" === c.type && e.md.linkify.test(c.content)) {
                        for (p = c.content, k = e.md.linkify.match(p), l = [], d = c.level, f = 0, u = 0; u < k.length; u++) _ = k[u].url, g = e.md.normalizeLink(_), e.md.validateLink(g) && (b = k[u].text, b = k[u].schema ? "mailto:" !== k[u].schema || /^mailto:/i.test(b) ? e.md.normalizeLinkText(b) : e.md.normalizeLinkText("mailto:" + b).replace(/^mailto:/, "") : e.md.normalizeLinkText("http://" + b).replace(/^http:\/\//, ""), (h = k[u].index) > f && ((a = new e.Token("text", "", 0)).content = p.slice(f, h), a.level = d, l.push(a)), (a = new e.Token("link_open", "a", 1)).attrs = [["href", g]], a.level = d++, a.markup = "linkify", a.info = "auto", l.push(a), (a = new e.Token("text", "", 0)).content = b, a.level = d, l.push(a), (a = new e.Token("link_close", "a", -1)).level = --d, a.markup = "linkify", a.info = "auto", l.push(a), f = k[u].lastIndex);
                        f < p.length && ((a = new e.Token("text", "", 0)).content = p.slice(f), a.level = d, l.push(a)), C[t].children = i = n(i, r, l)
                    }
                } else for (r--; i[r].level !== c.level && "link_open" !== i[r].type;) r--
            }
            ...
            "use strict";
            var n = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, s = /\((c|tm|r|p)\)/i, o = /\((c|tm|r|p)\)/gi,
                i = {c: "\xa9", r: "\xae", p: "\xa7", tm: "\u2122"};
            ...
            function c(e) {
                var r, t, n = 0;
                for (r = e.length - 1; r >= 0; r--) "text" !== (t = e[r]).type || n || (t.content = t.content.replace(o, a)), "link_open" === t.type && "auto" === t.info && n--, "link_close" === t.type && "auto" === t.info && n++
            }

            function l(e) {
                var r, t, s = 0;
                for (r = e.length - 1; r >= 0; r--) "text" !== (t = e[r]).type || s || n.test(t.content) && (t.content = t.content.replace(/\+-/g, "\xb1").replace(/\.{2,}/g, "\u2026").replace(/([?!])\u2026/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---([^-]|$)/gm, "$1\u2014$2").replace(/(^|\s)--(\s|$)/gm, "$1\u2013$2").replace(/(^|[^-\s])--([^-\s]|$)/gm, "$1\u2013$2")), "link_open" === t.type && "auto" === t.info && s--, "link_close" === t.type && "auto" === t.info && s++
            }

            r.exports = function (e) {
                var r;
                if (e.md.options.typographer) for (r = e.tokens.length - 1; r >= 0; r--) "inline" === e.tokens[r].type && (s.test(e.tokens[r].content) && c(e.tokens[r].children), n.test(e.tokens[r].content) && l(e.tokens[r].children))
            }
        }, {}], 35: [function (e, r, t) {
            "use strict";
            var n = e("../common/utils").isWhiteSpace, s = e("../common/utils").isPunctChar,
                o = e("../common/utils").isMdAsciiPunct, i = /['"]/, a = /['"]/g, c = "\u2019";
            ...
            function u(e, r) {
                var t, i, u, p, h, f, d, m, _, g, b, k, v, C, x, y, A, w, D, E, q;
                for (D = [], t = 0; t < e.length; t++) {
                    for (i = e[t], d = e[t].level, A = D.length - 1; A >= 0 && !(D[A].level <= d); A--) ;
                    if (D.length = A + 1, "text" === i.type) {
                        h = 0, f = (u = i.content).length;
                        e:for (; h < f && (a.lastIndex = h, p = a.exec(u));) {
                            if (x = y = !0, h = p.index + 1, w = "'" === p[0], _ = 32, p.index - 1 >= 0) _ = u.charCodeAt(p.index - 1); else for (A = t - 1; A >= 0 && ("softbreak" !== e[A].type && "hardbreak" !== e[A].type); A--) if ("text" === e[A].type) {
                                _ = e[A].content.charCodeAt(e[A].content.length - 1);
                                break
                            }
                            if (g = 32, h < f) g = u.charCodeAt(h); else for (A = t + 1; A < e.length && ("softbreak" !== e[A].type && "hardbreak" !== e[A].type); A++) if ("text" === e[A].type) {
                                g = e[A].content.charCodeAt(0);
                                break
                            }
                            if (b = o(_) || s(String.fromCharCode(_)), k = o(g) || s(String.fromCharCode(g)), v = n(_), (C = n(g)) ? x = !1 : k && (v || b || (x = !1)), v ? y = !1 : b && (C || k || (y = !1)), 34 === g && '"' === p[0] && _ >= 48 && _ <= 57 && (y = x = !1), x && y && (x = !1, y = k), x || y) {
                                if (y) for (A = D.length - 1; A >= 0 && (m = D[A], !(D[A].level < d)); A--) if (m.single === w && D[A].level === d) {
                                    m = D[A], w ? (E = r.md.options.quotes[2], q = r.md.options.quotes[3]) : (E = r.md.options.quotes[0], q = r.md.options.quotes[1]), i.content = l(i.content, p.index, q), e[m.token].content = l(e[m.token].content, m.pos, E), h += q.length - 1, m.token === t && (h += E.length - 1), f = (u = i.content).length, D.length = A;
                                    continue e
                                }
                                x ? D.push({
                                    token: t,
                                    ...
                                    single: w,
                                    level: d
                                }) : y && w && (i.content = l(i.content, p.index, c))
                            } else w && (i.content = l(i.content, p.index, c))
                        }
                    }
                }
            }
            ...
            r.exports = function (e) {
                var r;
                if (e.md.options.typographer) for (r = e.tokens.length - 1; r >= 0; r--) "inline" === e.tokens[r].type && i.test(e.tokens[r].content) && u(e.tokens[r].children, e)
            }
            ...
            s.prototype.Token = n, r.exports = s
            ...
            r.exports = function (e) {
                ...
                for (r = 0; r < i; r++) if ((n = o[r]).close) for (t = r - n.jump - 1; t >= 0;) {
                    if ((s = o[t]).open && s.marker === n.marker && s.end < 0 && s.level === n.level) {
                        var a = !1;
                        if ((s.close || n.open) && void 0 !== s.length && void 0 !== n.length && (s.length + n.length) % 3 == 0 && (s.length % 3 == 0 && n.length % 3 == 0 || (a = !0)), !a) {
            ...
            r.exports = function (e, r) {
                ...
                if ((u = c + 1) < k && 40 === e.src.charCodeAt(u)) {
                    ...
                    if (u >= k) return !1;
                    for (_ = u, (h = e.md.helpers.parseLinkDestination(e.src, u, e.posMax)).ok && (g = e.md.normalizeLink(h.str), e.md.validateLink(g) ? u = h.pos : g = ""), _ = u; u < k && (o = e.src.charCodeAt(u), s(o) || 10 === o); u++) ;
                    ...
                    if (u < k && 91 === e.src.charCodeAt(u) ? (_ = u + 1, (u = e.md.helpers.parseLinkLabel(e, u)) >= 0 ? a = e.src.slice(_, u++) : u = c + 1) : u = c + 1, a || (a = e.src.slice(l, c)), !(p = e.env.references[n(a)])) return e.pos = b, !1;
                    g = p.href, f = p.title
                }
                return r || (i = e.src.slice(l, c), e.md.inline.parse(i, e.md, e.env, m = []), (d = e.push("image", "img", 0)).attrs = t = [["src", g], ["alt", ""]], d.children = m, d.content = i, f && t.push(["title", f])), e.pos = u, e.posMax = k, !0
            }
            ...
            r.exports = function (e, r) {
                ...
                if ((l = a + 1) < m && 40 === e.src.charCodeAt(l)) {
                    for (g = !1, l++; l < m && (o = e.src.charCodeAt(l), s(o) || 10 === o); l++) ;
                    if (l >= m) return !1;
                    for (_ = l, (u = e.md.helpers.parseLinkDestination(e.src, l, e.posMax)).ok && (f = e.md.normalizeLink(u.str), e.md.validateLink(f) ? l = u.pos : f = ""), _ = l; l < m && (o = e.src.charCodeAt(l), s(o) || 10 === o); l++) ;
                    if (u = e.md.helpers.parseLinkTitle(e.src, l, e.posMax), l < m && _ !== l && u.ok) for (h = u.str, l = u.pos; l < m && (o = e.src.charCodeAt(l), s(o) || 10 === o); l++) ; else h = "";
                    (l >= m || 41 !== e.src.charCodeAt(l)) && (g = !0), l++
                }
                if (g) {
                    if (void 0 === e.env.references) return !1;
                    if (l < m && 91 === e.src.charCodeAt(l) ? (_ = l + 1, (l = e.md.helpers.parseLinkLabel(e, l)) >= 0 ? i = e.src.slice(_, l++) : l = a + 1) : l = a + 1, i || (i = e.src.slice(c, a)), !(p = e.env.references[n(i)])) return e.pos = d, !1;
                    f = p.href, h = p.title
                }
                return r || (e.pos = c, e.posMax = a, e.push("link_open", "a", 1).attrs = t = [["href", f]], h && t.push(["title", h]), e.md.inline.tokenize(e), e.push("link_close", "a", -1)), e.pos = l, e.posMax = m, !0
            }
            ...
            "use strict";
            var n = e("../token"), s = e("../common/utils").isWhiteSpace, o = e("../common/utils").isPunctChar,
                i = e("../common/utils").isMdAsciiPunct;
            ...
            a.prototype.pushPending = function () {
                ...
                var t, n, a, c, l, u, p, h, f, d = e, m = !0, _ = !0, g = this.posMax, b = this.src.charCodeAt(e);
                for (t = e > 0 ? this.src.charCodeAt(e - 1) : 32; d < g && this.src.charCodeAt(d) === b;) d++;
                return a = d - e, n = d < g ? this.src.charCodeAt(d) : 32, p = i(t) || o(String.fromCharCode(t)), f = i(n) || o(String.fromCharCode(n)), u = s(t), (h = s(n)) ? m = !1 : f && (u || p || (m = !1)), u ? _ = !1 : p && (h || f || (_ = !1)), r ? (c = m, l = _) : (c = m && (!_ || p), l = _ && (!m || f)), {
                    can_open: c,
                    can_close: l,
                    length: a
                }
            }, a.prototype.Token = n, r.exports = a
            ...
            r.exports = function (e) {
                ...
                for (r = t = 0; r < o; r++) s[r].nesting < 0 && n--, s[r].level = n, s[r].nesting > 0 && n++, "text" === s[r].type && r + 1 < o && "text" === s[r + 1].type ? s[r + 1].content = s[r].content + s[r + 1].content : (r !== t && (s[t] = s[r]), t++);
                r !== t && (s.length = t)
            }
        }, {}], 51: [function (e, r, t) {
            "use strict";
            ...
            function p(r) {
                var t = r.re = e("./lib/re")(r.__opts__), n = r.__tlds__.slice();

                function a(e) {
                    return e.replace("%TLDS%", t.src_tlds)
                }

                r.onCompile(), r.__tlds_replaced__ || n.push(l), n.push(t.src_xn), t.src_tlds = n.join("|"), t.email_fuzzy = RegExp(a(t.tpl_email_fuzzy), "i"), t.link_fuzzy = RegExp(a(t.tpl_link_fuzzy), "i"), t.link_no_ip_fuzzy = RegExp(a(t.tpl_link_no_ip_fuzzy), "i"), t.host_fuzzy_test = RegExp(a(t.tpl_host_fuzzy_test), "i");
                var c = [];
                ...
                r.__compiled__ = {}, Object.keys(r.__schemas__).forEach(function (e) {
                    ...
                    if (null !== t) {
                        ...
                        if (r.__compiled__[e] = n, "[object Object]" === s(t)) return !function (e) {
                            return "[object RegExp]" === s(e)
                        }(t.validate) ? o(t.validate) ? n.validate = t.validate : u(e, t) : n.validate = function (e) {
                            return function (r, t) {
                                var n = r.slice(t);
                                return e.test(n) ? n.match(e)[0].length : 0
                            }
                        }(t.validate), void (o(t.normalize) ? n.normalize = t.normalize : t.normalize ? u(e, t) : n.normalize = function (e, r) {
                            r.normalize(e)
                        });
                        !function (e) {
                    ...
                    validate: null, normalize: function (e, r) {
                        r.normalize(e)
                    }
                };
                var p = Object.keys(r.__compiled__).filter(function (e) {
                    return e.length > 0 && r.__compiled__[e]
                }).map(i).join("|");
                r.re.schema_test = RegExp("(^|(?!_)(?:[><\uff5c]|" + t.src_ZPCc + "))(" + p + ")", "i"), r.re.schema_search = RegExp("(^|(?!_)(?:[><\uff5c]|" + t.src_ZPCc + "))(" + p + ")", "ig"), r.re.pretest = RegExp("(" + r.re.schema_test.source + ")|(" + r.re.host_fuzzy_test.source + ")|@", "i"), function (e) {
            ...
            function d(e, r) {
                ...
                }, !1) && (r = e, e = {})), this.__opts__ = n({}, a, r), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = n({}, c, e), this.__compiled__ = {}, this.__tlds__ = u, this.__tlds_replaced__ = !1, this.re = {}, p(this)
            }

            d.prototype.add = function (e, r) {
                return this.__schemas__[e] = r, p(this), this
            ...
            }, d.prototype.testSchemaAt = function (e, r, t) {
                return this.__compiled__[r.toLowerCase()] ? this.__compiled__[r.toLowerCase()].validate(e, t, this) : 0
            }, d.prototype.match = function (e) {
                var r = 0, t = [];
                this.__index__ >= 0 && this.__text_cache__ === e && (t.push(f(this, r)), r = this.__last_index__);
                for (var n = r ? e.slice(r) : e; this.test(n);) t.push(f(this, r)), n = n.slice(this.__last_index__), r += this.__last_index__;
                return t.length ? t : null
            }, d.prototype.tlds = function (e, r) {
            ...
            function s(e, r) {
                var t;
                return "string" != typeof r && (r = s.defaultChars), t = function (e) {
                    var r, t, s = n[e];
                    if (s) return s;
                    for (s = n[e] = [], r = 0; r < 128; r++) t = String.fromCharCode(r), s.push(t);
                    for (r = 0; r < e.length; r++) s[t = e.charCodeAt(r)] = "%" + ("0" + t.toString(16).toUpperCase()).slice(-2);
                    return s
                }(r), e.replace(/(%[a-f0-9]{2})+/gi, function (e) {
                    var r, n, s, o, i, a, c, l = "";
                    for (r = 0, n = e.length; r < n; r += 3) (s = parseInt(e.slice(r + 1, r + 3), 16)) < 128 ? l += t[s] : 192 == (224 & s) && r + 3 < n && 128 == (192 & (o = parseInt(e.slice(r + 4, r + 6), 16))) ? (l += (c = s << 6 & 1984 | 63 & o) < 128 ? "\ufffd\ufffd" : String.fromCharCode(c), r += 3) : 224 == (240 & s) && r + 6 < n && (o = parseInt(e.slice(r + 4, r + 6), 16), i = parseInt(e.slice(r + 7, r + 9), 16), 128 == (192 & o) && 128 == (192 & i)) ? (l += (c = s << 12 & 61440 | o << 6 & 4032 | 63 & i) < 2048 || c >= 55296 && c <= 57343 ? "\ufffd\ufffd\ufffd" : String.fromCharCode(c), r += 6) : 240 == (248 & s) && r + 9 < n && (o = parseInt(e.slice(r + 4, r + 6), 16), i = parseInt(e.slice(r + 7, r + 9), 16), a = parseInt(e.slice(r + 10, r + 12), 16), 128 == (192 & o) && 128 == (192 & i) && 128 == (192 & a)) ? ((c = s << 18 & 1835008 | o << 12 & 258048 | i << 6 & 4032 | 63 & a) < 65536 || c > 1114111 ? l += "\ufffd\ufffd\ufffd\ufffd" : (c -= 65536, l += String.fromCharCode(55296 + (c >> 10), 56320 + (1023 & c))), r += 9) : l += "\ufffd";
                    return l
                })
            }
            ...
            function s(e, r, t) {
                var o, i, a, c, l, u = "";
                for ("string" != typeof r && (t = r, r = s.defaultChars), void 0 === t && (t = !0), l = function (e) {
                    var r, t, s = n[e];
                    if (s) return s;
                    for (s = n[e] = [], r = 0; r < 128; r++) t = String.fromCharCode(r), /^[0-9a-z]$/i.test(t) ? s.push(t) : s.push("%" + ("0" + r.toString(16).toUpperCase()).slice(-2));
                    for (r = 0; r < e.length; r++) s[e.charCodeAt(r)] = e[r];
                    return s
                }(r), o = 0, i = e.length; o < i; o++) if (a = e.charCodeAt(o), t && 37 === a && o + 2 < i && /^[0-9a-f]{2}$/i.test(e.slice(o + 1, o + 3))) u += e.slice(o, o + 3), o += 2; else if (a < 128) u += l[a]; else if (a >= 55296 && a <= 57343) {
            ...
            var s = /^([a-z0-9.+-]+:)/i, o = /:[0-9]*$/, i = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
                a = ["{", "}", "|", "\\", "^", "`"].concat(["<", ">", '"', "`", " ", "\r", "\n", "\t"]),
                c = ["'"].concat(a), l = ["%", "/", "?", ";", "#"].concat(c), u = ["/", "?", "#"],
                p = /^[+a-z0-9A-Z_-]{0,63}$/, h = /^([+a-z0-9A-Z_-]{0,63})(.*)$/,
            ...
            n.prototype.parse = function (e, r) {
                ...
                var g = s.exec(m);
                if (g && (o = (g = g[0]).toLowerCase(), this.protocol = g, m = m.substr(g.length)), (r || g || m.match(/^\/\/[^@\/]+@[^@\/]+/)) && (!(c = "//" === m.substr(0, 2)) || g && f[g] || (m = m.substr(2), this.slashes = !0)), !f[g] && (c || g && !d[g])) {
                    var b, k, v = -1;
                    for (t = 0; t < u.length; t++) -1 !== (a = m.indexOf(u[t])) && (-1 === v || a < v) && (v = a);
                    for (-1 !== (k = -1 === v ? m.lastIndexOf("@") : m.lastIndexOf("@", v)) && (b = m.slice(0, k), m = m.slice(k + 1), this.auth = b), v = -1, t = 0; t < l.length; t++) -1 !== (a = m.indexOf(l[t])) && (-1 === v || a < v) && (v = a);
                    ...
                    if (!x) {
                        ...
                        for (t = 0, n = y.length; t < n; t++) {
                            ...
                            if (A && !A.match(p)) {
                                ...
                                if (!w.match(p)) {
                                    var q = y.slice(0, t), F = y.slice(t + 1), S = A.match(h);
                                    S && (q.push(S[1]), F.unshift(S[2])), F.length && (m = F.join(".") + m), this.hostname = q.join(".");
                                    break
                                }
                            }
                        }
            ...
            (function (e) {
                !function (n) {
                    var s = "object" == typeof t && t && !t.nodeType && t,
                        o = "object" == typeof r && r && !r.nodeType && r, i = "object" == typeof e && e;
                    i.global !== i && i.window !== i && i.self !== i || (n = i);
                    var a, c, l = 2147483647, u = 36, p = 1, h = 26, f = 38, d = 700, m = 72, _ = 128, g = "-",
                        b = /^xn--/, k = /[^\x20-\x7E]/, v = /[\x2E\u3002\uFF0E\uFF61]/g, C = {
                            overflow: "Overflow: input needs wider integers to process",
                            "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                            "invalid-input": "Invalid input"
                        }, x = u - p, y = Math.floor, A = String.fromCharCode;
                    ...
                    function E(e, r) {
                        var t = e.split("@"), n = "";
                        return t.length > 1 && (n = t[0] + "@", e = t[1]), n + D((e = e.replace(v, ".")).split("."), r).join(".")
                    }
                    ...
                    function F(e) {
                        return D(e, function (e) {
                            var r = "";
                            return e > 65535 && (r += A((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), r += A(e)
                        }).join("")
                    }
                    ...
                    function L(e, r, t) {
                        var n = 0;
                        for (e = t ? y(e / d) : e >> 1, e += y(e / r); e > x * h >> 1; n += u) e = y(e / x);
                        return y(n + (x + 1) * e / (e + f))
                    }

                    function z(e) {
                        var r, t, n, s, o, i, a, c, f, d, b, k = [], v = e.length, C = 0, x = _, A = m;
                        for ((t = e.lastIndexOf(g)) < 0 && (t = 0), n = 0; n < t; ++n) e.charCodeAt(n) >= 128 && w("not-basic"), k.push(e.charCodeAt(n));
                        for (s = t > 0 ? t + 1 : 0; s < v;) {
                            for (o = C, i = 1, a = u; s >= v && w("invalid-input"), ((c = (b = e.charCodeAt(s++)) - 48 < 10 ? b - 22 : b - 65 < 26 ? b - 65 : b - 97 < 26 ? b - 97 : u) >= u || c > y((l - C) / i)) && w("overflow"), C += c * i, !(c < (f = a <= A ? p : a >= A + h ? h : a - A)); a += u) i > y(l / (d = u - f)) && w("overflow"), i *= d;
                            A = L(C - o, r = k.length + 1, 0 == o), y(C / r) > l - x && w("overflow"), x += y(C / r), C %= r, k.splice(C++, 0, x)
                        }
                        return F(k)
                    }

                    function T(e) {
                        var r, t, n, s, o, i, a, c, f, d, b, k, v, C, x, D = [];
                        for (k = (e = q(e)).length, r = _, t = 0, o = m, i = 0; i < k; ++i) (b = e[i]) < 128 && D.push(A(b));
                        for (n = s = D.length, s && D.push(g); n < k;) {
                            for (a = l, i = 0; i < k; ++i) (b = e[i]) >= r && b < a && (a = b);
                            for (a - r > y((l - t) / (v = n + 1)) && w("overflow"), t += (a - r) * v, r = a, i = 0; i < k; ++i) if ((b = e[i]) < r && ++t > l && w("overflow"), b == r) {
                                for (c = t, f = u; !(c < (d = f <= o ? p : f >= o + h ? h : f - o)); f += u) x = c - d, C = u - d, D.push(A(S(d + x % C, 0))), c = y(x / C);
                                D.push(A(S(c, 0))), o = L(t, v, n == s), t = 0, ++n
                            }
                            ++t, ++r
                        }
                        return D.join("")
                    ...
                    if (a = {
                        ...
                        toUnicode: function (e) {
                            return E(e, function (e) {
                                return b.test(e) ? z(e.slice(4).toLowerCase()) : e
                            })
                        }
                    }, s && o) if (r.exports == s) o.exports = a; else for (c in a) a.hasOwnProperty(c) && (s[c] = a[c]); else n.punycode = a
                }(this)
