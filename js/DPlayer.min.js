!function (e, t) {
    ...
    return function (e) {
        ...
        var r = a(6), o = Object.prototype.toString;
        ...
        function p(e, t) {
            if (null != e) if ("object" !== n(e) && (e = [e]), i(e)) for (var a = 0, r = e.length; a < r; a++) t.call(null, e[a], a, e); else for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && t.call(null, e[o], o, e)
        }
        ...
        e.exports = {
            ...
            }, isObject: s, isUndefined: l, isDate: function (e) {
        ...
        e.exports = function (e) {
            "use strict";
            var t = "", a = (e = e || {}).enableSubtitle, r = e.subtitle, o = e.current, i = e.pic, l = n.$escape,
                s = e.screenshot, d = e.preload, p = e.url;
            a = r && "webvtt" === r.type;
        ...
        e.exports = function (e, t, a) {
            if (!t) return e;
            var o;
            if (a) o = a(t); else if (n.isURLSearchParams(t)) o = t.toString(); else {
                var i = [];
        ...
        "use strict";
        (function (t) {
            var n = a(0), r = a(45), o = {"Content-Type": "application/x-www-form-urlencoded"};
        ...
        "use strict";
        var n = a(0), r = a(46), o = a(7), i = a(48), l = a(51), s = a(52), d = a(11);
        e.exports = function (e) {
            return new Promise((function (t, p) {
                ...
                if (y.open(e.method.toUpperCase(), o(f, e.params, e.paramsSerializer), !0), y.timeout = e.timeout, y.onreadystatechange = function () {
                    if (y && 4 === y.readyState && (0 !== y.status || y.responseURL && 0 === y.responseURL.indexOf("file:"))) {
                        var a = "getAllResponseHeaders" in y ? l(y.getAllResponseHeaders()) : null, n = {
        ...
        e.exports = function (e, t) {
            t = t || {};
            var a = {}, r = ["url", "method", "params", "data"], o = ["headers", "auth", "proxy"],
            ...
            var l = r.concat(o).concat(i), s = Object.keys(t).filter((function (e) {
        ...
        e.exports = function (e) {
            "use strict";
            e = e || {};
            var t = "", r = (arguments[1], function (e) {
                return t += e
            }), o = e.video, i = e.options, l = n.$escape, s = e.tran, d = e.icons, p = e.index, c = n.$each;
            e.$value, e.$index;
        ...
        var o = {insert: "head", singleton: !1}, i = (n(r, o), r.locals ? r.locals : {});
        e.exports = i
    }, function (e, t, a) {
        "use strict";
        var n, r = function () {
        ...
        function l(e) {
            for (var t = -1, a = 0; a < i.length; a++) if (i[a].identifier === e) {
                t = a;
                break
            }
            return t
        ...
        function s(e, t) {
            for (var a = {}, n = [], r = 0; r < e.length; r++) {
                var o = e[r], s = t.base ? o[0] + t.base : o[0], d = a[s] || 0, p = "".concat(s, " ").concat(d);
                a[s] = d + 1;
                var c = l(p), u = {css: o[1], media: o[2], sourceMap: o[3]};
        ...
        function u(e, t, a, n) {
            ...
            if (e.styleSheet) e.styleSheet.cssText = c(t, r); else {
                var o = document.createTextNode(r), i = e.childNodes;
                i[t] && e.removeChild(i[t]), i.length ? e.insertBefore(o, i[t]) : e.appendChild(o)
            }
        }

        function y(e, t, a) {
            var n = a.css, r = a.media, o = a.sourceMap;
            if (r ? e.setAttribute("media", r) : e.removeAttribute("media"), o && btoa && (n += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(o)))), " */")), e.styleSheet) e.styleSheet.cssText = n; else {
        ...
        (function (e, t) {
            !function (e, a) {
                "use strict";
                if (!e.setImmediate) {
                    var n, r, o, i, l, s = 1, d = {}, p = !1, c = e.document,
        ...
        "use strict";
        var n = a(0), r = a(6), o = a(41), i = a(12);

        function l(e) {
            var t = new o(e), a = r(o.prototype.request, t);
        ...
        "use strict";
        var n = a(0), r = a(7), o = a(42), i = a(43), l = a(12);
        ...
        s.prototype.request = function (e) {
            ...
            s.prototype[e] = function (t, a, r) {
                return this.request(n.merge(r || {}, {method: e, url: t, data: a}))
            }
        })), e.exports = s
    }, function (e, t, a) {
        "use strict";
        ...
        (function (t) {
            ...
            n.$escape = function (e) {
                return function (e) {
                    var t = "" + e, a = r.exec(t);
                    if (!a) return e;
                    var n = "", o = void 0, i = void 0, l = void 0;
                ...
                if (Array.isArray(e)) for (var a = 0, n = e.length; a < n; a++) t(e[a], a); else for (var r in e) t(e[r], r)
            }, e.exports = n
        }).call(this, a(4))
    }, function (e, t, a) {
        "use strict";
        a.r(t);
        a(34);
        var n = a(15), r = /mobile/i.test(window.navigator.userAgent), o = {
            secondToTime: function (e) {
                if (0 === (e = e || 0) || e === 1 / 0 || "NaN" === e.toString()) return "00:00";
                var t = Math.floor(e / 3600), a = Math.floor((e - 3600 * t) / 60),
            ...
            getElementViewLeft: function (e) {
                var t = e.offsetLeft, a = e.offsetParent,
                    n = document.body.scrollLeft + document.documentElement.scrollLeft;
                if (document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement) for (; null !== a && a !== e;) t += a.offsetLeft, a = a.offsetParent; else for (; null !== a;) t += a.offsetLeft, a = a.offsetParent;
                return t - n
            },
            getBoundingClientRectViewLeft: function (e) {
                ...
                if (e.getBoundingClientRect) {
                    ...
                    var n = e.getBoundingClientRect(), r = this.getBoundingClientRectViewLeft.offset;
                    return n.left + r
                }
            ...
            setScrollPosition: function (e) {
                var t = e.left, a = void 0 === t ? 0 : t, n = e.top, r = void 0 === n ? 0 : n;
        ...
        var c = {
            ...
            }, y = a(17), m = a.n(y), h = a(18), f = a.n(h), b = a(19), v = a.n(b), g = a(20), w = a.n(g), k = a(21),
            x = a.n(k), S = a(22), T = a.n(S), L = a(23), E = a.n(L), Y = a(24), q = a.n(Y), B = a(25), M = a.n(B),
            z = a(26), C = a.n(z), O = a(27), j = a.n(O), P = a(28), A = a.n(P), F = a(29), _ = a.n(F), D = a(30),
            R = a.n(D), I = a(31), W = a.n(I), H = a(32), N = a.n(H), U = {
                play: m.a,
                pause: f.a,
                volumeUp: v.a,
                volumeDown: w.a,
        ...
        var Z = function () {
            ...
            return t = e, (a = [{
                ...
                key: "draw", value: function (e) {
                    var t = this;
                    if (this.showing) {
                        var a = this.options.height, n = this.container.offsetWidth, r = this.container.offsetHeight,
                            i = parseInt(r / a), l = function (e) {
                        ...
                        for (var p = document.createDocumentFragment(), c = function (r) {
                            ...
                            var l = t._measure(e[r].text), s = void 0;
                            switch (e[r].type) {
                                case"right":
        ...
        var ae = function () {
            ...
            return t = e, (a = [{
                ...
                key: "request", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "browser",
                        t = "browser" === e ? "web" : "browser", a = this.isFullScreen(t);
        ...
        var ze = 0, Ce = [], Oe = function () {
            ...
            return t = e, r = [{
                ...
                key: "play", value: function (e) {
                    ...
                    })), this.timer.enable("loading"), this.container.classList.remove("dplayer-paused"), this.container.classList.add("dplayer-playing"), this.danmaku && this.danmaku.play(), this.options.mutex) for (var a = 0; a < Ce.length; a++) this !== Ce[a] && Ce[a].pause()
                }
            }, {
                ...
                key: "initMSE", value: function (e, t) {
                    var a = this;
                    if (this.type = t, this.options.video.customType && this.options.video.customType[t]) "[object Function]" === Object.prototype.toString.call(this.options.video.customType[t]) ? this.options.video.customType[t](this.video, this) : console.error("Illegal customType: ".concat(t)); else switch ("auto" === this.type && (/m3u8(#|\?|$)/i.exec(e.src) ? this.type = "hls" : /.flv(#|\?|$)/i.exec(e.src) ? this.type = "flv" : /.mpd(#|\?|$)/i.exec(e.src) ? this.type = "dash" : this.type = "normal"), "hls" === this.type && (e.canPlayType("application/x-mpegURL") || e.canPlayType("application/vnd.apple.mpegURL")) && (this.type = "normal"), this.type) {
                        case"hls":
                            if (window.Hls) if (window.Hls.isSupported()) {
                                var n = this.options.pluginOptions.hls, r = new window.Hls(n);
                        ...
                        case"flv":
                            if (window.flvjs) if (window.flvjs.isSupported()) {
                                var o = Object.assign(this.options.pluginOptions.flvjs, {type: "flv", url: e.src}),
                        ...
                        case"webtorrent":
                            if (window.WebTorrent) if (window.WebTorrent.WEBRTC_SUPPORT) {
                                ...
                                var d = this.options.pluginOptions.webtorrent, p = new window.WebTorrent(d);
                ...
                key: "notice", value: function (e) {
                    var t = this, a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2e3,
